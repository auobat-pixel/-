...
export default function App() {
  ...
  const stats = {
    ...
    totalValue: listings.reduce((acc, curr) => acc + ((curr.pricePerMeterLimit || 0) * (curr.area || 0)), 0),
    avgPrice: listings.length > 0 ? listings.reduce((acc, curr) => acc + ((curr.pricePerMeterLimit || 0) * (curr.area || 0)), 0) / listings.length : 0
  };
