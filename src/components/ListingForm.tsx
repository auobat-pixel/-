...
export const ListingForm: React.FC<ListingFormProps> = ({ onAdd, editingListing, onUpdate, onCancelEdit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const data = {
      ...
      pricePerMeterLimit: pricePerMeterLimit ? Number(pricePerMeterLimit) : null,
      pricePerMeterSaowm: pricePerMeterSaowm ? Number(pricePerMeterSaowm) : null,
      dimNorth: dimNorth || null,
      dimSouth: dimSouth || null,
      dimEast: dimEast || null,
      dimWest: dimWest || null,
    };
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">سعر المتر حد</label>
            <div className="relative">
              <Tag className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
              <input
                type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">سعر المتر سوم</label>
            <div className="relative">
              <Gavel className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
              <input
                type="number"
